...
var Profit=0,Buy_Order=0,Sell_Order=0;
...
//-------------------------------------------------------------------------------------------------
      ...
      EMA_100 = EMA.calculate({ period: EMA_Setting, values: Live_candles_data_input });
      console.log('period of ',String(EMA_Setting),' EMA_100  = >', EMA_100[500 - EMA_Setting]);
      console.log();
//----------------------------------------------------------------------------------------------
      EMA_Setting = 100;
      let EMA_1 = EMA.calculate({ period: EMA_Setting, values: Live_candles_data_input });
      // console.log('period of ',String(EMA_Setting),' EMA_1  = >', EMA_1[500 - EMA_Setting]);
      // console.log();

      let EMA_2 = EMA.calculate({ period: EMA_Setting, values: EMA_1 });
      // console.log('period of ',String(EMA_Setting),' EMA_2   = >', EMA_2[500 - (EMA_Setting*2)]);
      // console.log();

      let EMA_3 = EMA.calculate({ period: EMA_Setting, values: EMA_2 });
      ...
      TEMA = (3 * EMA_1[500-EMA_Setting]) - (3 * EMA_2[500-(EMA_Setting*2)]) + EMA_3[500 - (EMA_Setting*3)];      
      console.log('period of ',String(EMA_Setting),' TEMA     = >', TEMA);//[500-EMA_Setting*3]);
      // }
   ...
   //--------------------------------------------------------------
      ...
      let EMA_5 = EMA.calculate({ period: EMA_Setting, values: Live_candles_data_input });
      console.log('period of   ',String(EMA_Setting),' EMA_5    = >', EMA_5[500 - EMA_Setting]);

      console.log('Difference               =>',TEMA-EMA_5[500 - 5]);
      console.log();
//--------------------------------------------------------------------------------------------
if(TEMA < EMA_5[500-5])
{
...
if(TEMA > EMA_5[500-5])
{
   if(buy_status == 1)
   {
      ...
      // if(EMA_100[500-100] < EMA_5[500-5])
      // {
      //    if(buy_status == 0)
      //    {
      //       Buy_Order = Live_candles_data_input[499];
